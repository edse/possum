...
abstract class BaseAssetQuestionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'spreadsheet_id'         => new sfWidgetFormFilterInput(),
      'worksheet_id'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'spreadsheet_id'         => new sfValidatorPass(array('required' => false)),
      'worksheet_id'           => new sfValidatorPass(array('required' => false)),
