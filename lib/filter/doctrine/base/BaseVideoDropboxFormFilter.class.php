...
abstract class BaseVideoDropboxFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'asset_video_gallery_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('AssetVideoGallery'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'asset_video_gallery_id' => 'ForeignKey',
      'youtube_id'             => 'Text',
      'action'                 => 'Text',
      'folder'                 => 'Text',
      'status'                 => 'Text',
