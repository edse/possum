...
abstract class BaseScheduleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tv_rating'         => new sfWidgetFormFilterInput(),
      'tv_category'       => new sfWidgetFormFilterInput(),
      ...
      'is_geoblocked'     => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'tv_rating'         => new sfValidatorPass(array('required' => false)),
      'tv_category'       => new sfValidatorPass(array('required' => false)),
      ...
      'is_geoblocked'     => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
