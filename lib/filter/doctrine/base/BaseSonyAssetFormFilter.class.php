...
/**
 * SonyAsset filter form base class.
 *
 * @package    astolfo
 * @subpackage filter
 ...
 */
abstract class BaseSonyAssetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sony_asset_filters[%s]');
  ...
  public function addSonyCategoriesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('SonyCategoryAsset.sony_category_id', $values)
    ;
  }
