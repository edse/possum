...
abstract class BaseScheduleForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tv_rating'         => new sfWidgetFormInputText(),
      'tv_category'       => new sfWidgetFormInputText(),
      ...
      'is_geoblocked'     => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'tv_rating'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'tv_category'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'is_geoblocked'     => new sfValidatorBoolean(array('required' => false)),
