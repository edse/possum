...
abstract class BaseVideoDropboxForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'asset_video_gallery_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('AssetVideoGallery'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'asset_video_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AssetVideo'), 'required' => false)),
      'asset_video_gallery_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AssetVideoGallery'), 'required' => false)),
