...
abstract class BaseAssetQuestionForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'spreadsheet_id'         => new sfWidgetFormInputText(),
      'worksheet_id'           => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'spreadsheet_id'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'worksheet_id'           => new sfValidatorString(array('max_length' => 255, 'required' => false)),
