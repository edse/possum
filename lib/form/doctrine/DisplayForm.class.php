...
class DisplayForm extends BaseDisplayForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['title'] = new sfWidgetFormInputText(array(), array('style' => 'width: 650px;'));
    ...
    $this->widgetSchema['label'] = new sfWidgetFormInputText(array(), array('style' => 'width: 250px;'));
    ...
    $this->widgetSchema['type'] = new sfWidgetFormChoice(array(
      'choices' => array('Default' => 'Default', 'content' => 'Content', 'video' => 'Video', 'image' => 'Image', 'audio' => 'Audio')
    ));
