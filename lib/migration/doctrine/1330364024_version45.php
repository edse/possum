...
class Version45 extends Doctrine_Migration_Base
{
	...
	$this->dropTable('trebuchet_asset');
        ...
        $this->createTable('sony_asset', array(
             'id' => 
             array(
              'type' => 'integer',
              'length' => '8',
        ...
        $this->createTable('sony_category', array(
             'id' => 
             array(
              'type' => 'integer',
              'length' => '8',
        ...
        $this->createTable('sony_category_asset', array(
             'id' => 
             array(
              'type' => 'integer',
              'length' => '8',
    ...
    public function down()
    {
        ...
        $this->dropTable('sony_asset');
        $this->dropTable('sony_category');
        $this->dropTable('sony_category_asset');
    }
}
