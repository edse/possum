...
class Version49 extends Doctrine_Migration_Base
{
    public function up()
    {
        ...
        //$this->removeColumn('sony_category_asset', 'created_at');
        //$this->removeColumn('sony_category_asset', 'updated_at');
    }
    ...
    public function down()
    {
        ...
        $this->addColumn('sony_category_asset', 'created_at', 'timestamp', '25', array(
             'notnull' => '1',
             ));
        $this->addColumn('sony_category_asset', 'updated_at', 'timestamp', '25', array(
             'notnull' => '1',
             ));
    }
}
