...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_bar">
    <?php include_partial('section_assets/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('asset_section_assets_collection', array('action' => 'batch')) ?>" method="post">
    <?php include_partial('section_assets/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
    <ul class="sf_admin_actions">
      <?php include_partial('section_assets/list_batch_actions', array('helper' => $helper)) ?>
      <?php include_partial('section_assets/list_actions', array('helper' => $helper)) ?>
    </ul>
    </form>
  </div>
