<div class="sf_admin_pagination">
  <a href="<?php echo url_for("homepage")."section/".$section->getId()."/ListAssets?page=1"; ?>">
  ...
  <a href="<?php echo url_for("homepage")."section/".$section->getId()."/ListAssets?page=".$pager->getPreviousPage();?>">
  ...
  <?php foreach ($pager->getLinks() as $page): ?>
    <?php if ($page == $pager->getPage()): ?>
      <?php echo $page ?>
    <?php else: ?>
      <a href="<?php echo url_for("homepage")."section/".$section->getId()."/ListAssets?page=".$page;?>"><?php echo $page ?></a>
    <?php endif; ?>
  <?php endforeach; ?>

  <a href="<?php echo url_for("homepage")."section/".$section->getId()."/ListAssets?page=".$pager->getNextPage(); ?>">
  ...
  <a href="<?php echo url_for("homepage")."section/".$section->getId()."/ListAssets?page=".$pager->getLastPage();?>">
