...
<div class="page-header">
  <h1><?php echo __('Channel List', array(), 'messages') ?></h1>
</div>
...
<div class="row-fluid">
  ...
  <div class="span9">
    ...
    <div id="sf_admin_container">
      ...
      <div id="sf_admin_content">
        <form action="<?php echo url_for('channel_collection', array('action' => 'batch')) ?>" method="post">
  ...
  <div class="span3">
    <?php include_partial('channel/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>
