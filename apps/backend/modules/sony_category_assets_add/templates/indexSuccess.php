...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <form action="<?php echo url_for('sony_category_assets_add_collection', array('action' => 'batch')) ?>" method="post">
    <?php include_partial('sony_category_assets_add/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'category_id' => $category->id)) ?>
