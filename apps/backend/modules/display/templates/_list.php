...
<script>
  $(document).ready(function() {
    updateDisplay(<?php echo $block->id ?>);
  ...
  function updateDisplay(id){
    $.fancybox.close();
    $.ajax({
      url: '<?php echo url_for("display/ajaxupdate")?>',
      data: "block_id="+id,
      dataType: 'html',
  ...
  function deleteDisplay(id, block_id){
    if(confirm('Are you sure?')){
      $.ajax({
        url: '<?php echo url_for("display/ajaxdelete")?>',
        data: "id="+id,
        dataType: 'html',
        success: function(){
          updateDisplay(block_id);
        }
      });
    }
  }
  ...
  function setSortable(id) {
    $("#sort-list").sortable({
      ...
      update : function () {
        ...
        $.ajax({
          url: '<?php echo url_for("display/ajaxorder")?>',
          data: 'id='+id+'&'+order,
          dataType: 'html'
        });
      }
